(function(){
    ...
    app.directive('namedmdxComponentMultiSelect', ['$log','$rootScope','$tm1Ui','$timeout','orderByFilter',   function($log, $rootScope,$tm1Ui,$timeout,orderBy) {
        return {
            templateUrl: 'html/namedmdx-component-multi-select.html',
            scope:{
                componentHeight:'@',
